...
\begin{itemize}[leftmargin=*]
    \resumeSectionSubItmI{Current MSc Statistics student with an interest in
        machine learning and statistical modeling, particularly interested in
    ...
    \resumeSectionSubItmI{Able to undertake both theoretical and computational
        works, e.g., software development, statistical inference and modeling,
...
\begin{itemize}[leftmargin=*]
    ...
    \begin{itemize}[leftmargin=*]
        ...
        \item \it{\textbf{Prizes and Medals:}}
            ...
            \end{itemize}
        \item \it{\textbf{Dissertation:} Score-Based Diffusion Techniques and Diffusion Map Method for Generative Modeling.}
    \end{itemize}
\end{itemize}
...
\begin{itemize}[leftmargin=*]
    \resumeSectionSubItm{Core softwares:}{
        Python, R, Java, Haskell, HTML, CSS, \LaTeX, C, Processing,
        MIPS assembly, Swift, Docker, Node.js, ......
    }
    \resumeSectionSubItm{Tools \& Frameworks:}{
        Pacman, Git, Vim, Conda, PyTorch, LWJGL, Bootstrap, Jekyll, ......
    }
