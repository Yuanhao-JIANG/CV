...
\begin{itemize}[leftmargin=*]
    ...
    \begin{itemize}[leftmargin=*]
        ...
        \item \it{\textbf{Grades:}}\\
            \it{Year 1: First Class, average grade 91\% (equivalent GPA
            \(\approx\) 4.0)}\\
            \it{Year 2: First Class, average grade 89\% (equivalent GPA
            \(\approx\) 4.0)}\\
            \it{Year 3: First Class, average grade 87\% (equivalent GPA
            \(\approx\) 4.0)}\\
