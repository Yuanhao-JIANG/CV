...
\item
    \textbf{\parbox[t]{3.7cm}{#1\hfill}}\parbox[t]{14cm}{#2}\vspace{-2mm}
}
...
\begin{itemize}[leftmargin=*]
    \resumeSectionSubItmI{Current MSc Statistics student with an interest in
        statistical machine learning, modelling and reinforcement learning, particularly
        generative modelling and computer vision. Research experience in
...
\begin{itemize}[leftmargin=*]
    ...
    \begin{itemize}[leftmargin=*]
        \vspace{-1mm}
        \item \it{\textbf{Qualification:} \textbf{First Class}, average grade 86. \textbf{Ranked 1\textsuperscript{st} of 71 students.}}
...
\begin{itemize}[leftmargin=*]
    \resumeResearchItm{Score-Based Diffusion using Constrained Dynamics}{Supervisor: Prof. Benedict Leimkuhler}
    {June 2024 - Oct. 2024}\vspace{-2mm}
    \begin{itemize}[leftmargin=*]
        \setlength\itemsep{2mm}
        \resumeSectionSubItmI{We are trying to apply constrained SDEs in score-based diffusion models to restrict the data points on Riemannian manifolds, potentially allowing more structural and controllable data perturbation and data generation.}
    ...
    \end{itemize}\vspace{1mm}
    \resumeResearchItm{\hspace{-1.2mm}
...
\begin{itemize}[leftmargin=*]
    \resumeSectionSubItm{Core softwares:}{
        Python, R, Java, Haskell, HTML, CSS, \LaTeX, C, Processing, MIPS assembly, Swift, Docker, Node.js, Pacman, Vim, Git, Conda, PyTorch, LWJGL, Bootstrap, Jekyll, ......
    }
...
\begin{itemize}[leftmargin=*]
    ...
    %         program I wrote since I started to learn programming 6 years ago.
