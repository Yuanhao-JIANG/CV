...
\geometry{tmargin=0.65in, lmargin=0.63in, rmargin=0.62in, bmargin=0.72in}
...
\begin{itemize}[leftmargin=*]
    \resumeSectionSubItm{Programming \\Languages:}{Python, Java, R, HTML, CSS, LaTex, C, Processing, MIPS assembly}
    \resumeSectionSubItm{Tools \& Frameworks:}{VIM, PyTorch, Git, LWJGL, Bootstrap, SQLite}
    \resumeSectionSubItm{Platforms:}{Linux(Arch), MacOS, Windows}
    \resumeSectionSubItm{Languages:}{English, Chinese (Mandarin)}
    \resumeSectionSubItm{\small{Other skills: \vspace{-0.5mm}\newline (Very Basic Level)}}{JavaScript, C++, Swift, OpenGL, GLSL, Godot engine}
\end{itemize}
\vspace{-2.5mm}
